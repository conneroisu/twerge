// Package main is the entry point for the simple example application.
package main
...
import (
	...
	static "github.com/conneroisu/twerge/examples/simple/_static"
	"github.com/conneroisu/twerge/examples/simple/classes"
...
func AddRoutes(
	...
	mux.Handle("/{$}", templ.Handler(views.View()))
