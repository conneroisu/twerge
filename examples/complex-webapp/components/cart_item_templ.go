...
func CartItem(item models.CartItem) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 = []any{twerge.It("flex items-center py-4 border-b border-gray-200")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 1, Col: 0}
		}
		...
		var templ_7745c5c3_Var4 = []any{twerge.It("flex-shrink-0 w-24 h-24 bg-gray-100 rounded-md overflow-hidden")}
		...
		var templ_7745c5c3_Var6 = []any{twerge.It("w-full h-full object-center object-cover")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 13, Col: 31}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 14, Col: 27}
		}
		...
		var templ_7745c5c3_Var10 = []any{twerge.It("ml-4 flex-1 flex flex-col")}
		...
		var templ_7745c5c3_Var12 = []any{twerge.It("flex justify-between text-base font-medium text-gray-900")}
		...
		var templ_7745c5c3_Var14 = []any{twerge.It("hover:text-indigo-600")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 22, Col: 25}
		}
		...
		var templ_7745c5c3_Var18 = []any{twerge.It("ml-4")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 26, Col: 72}
		}
		...
		var templ_7745c5c3_Var21 = []any{twerge.It("mt-1 text-sm text-gray-500 line-clamp-1")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 29, Col: 95}
		}
		...
		var templ_7745c5c3_Var24 = []any{twerge.It("flex items-center justify-between text-sm mt-2")}
		...
		var templ_7745c5c3_Var26 = []any{twerge.It("flex border rounded")}
		...
		var templ_7745c5c3_Var28 = []any{twerge.It("px-2 py-1 border-r hover:bg-gray-100")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 34, Col: 69}
		}
		...
		var templ_7745c5c3_Var31 = []any{twerge.It("text-gray-500")}
		...
		var templ_7745c5c3_Var33 = []any{twerge.It("px-4 py-1 flex items-center justify-center")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 42, Col: 111}
		}
		...
		var templ_7745c5c3_Var36 = []any{twerge.It("px-2 py-1 border-l hover:bg-gray-100")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 45, Col: 69}
		}
		...
		var templ_7745c5c3_Var39 = []any{twerge.It("text-gray-500")}
		...
		var templ_7745c5c3_Var41 = []any{twerge.It("flex")}
		...
		var templ_7745c5c3_Var43 = []any{twerge.It("text-indigo-600 hover:text-indigo-500")}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `complex-webapp/components/cart_item.templ`, Line: 57, Col: 69}
		}
